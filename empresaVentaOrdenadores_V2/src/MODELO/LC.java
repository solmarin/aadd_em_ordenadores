...
public class LC {
	//Atributos
		...
		private boolean StatusLC;
		private double precioU;
		private double precioTLC;
	//Constructor
		public LC(int idLC, int unidades, int unidadesServidas,double precioU, boolean statusLC) {
			super();
			this.idLC = idLC;
	...
	//Metodos
		...
		public boolean isStatusLC() {
			return StatusLC;
		}

		public void setStatusLC(boolean statusLC) {
			StatusLC = statusLC;
		}
