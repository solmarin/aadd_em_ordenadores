...
public class Comanda {
	...
	//Constructors
		public Comanda(int idComanda, String idCliente,ArrayList<LC> productosSeleccionados, Date fechaE,char statusComanda) {
			super();
		...
		public Comanda(String idCliente,ArrayList<LC> productosSeleccionados, Date fechaE,char statusComanda) {
			super();
			this.idCliente = idCliente;
			this.statusComanda = statusComanda;
			this.fechaE = fechaE;
